...
export const api = {
  ...
  createFootageVariant: (id, params) => request(`/projects/${encodeURIComponent(id)}/footage-variant`, { method: "POST", body: JSON.stringify(params ?? {}) }),
  listFootageFolders: () => request("/footage-library/folders"),
  createFootageFolder: (name) => request("/footage-library/folders", { method: "POST", body: JSON.stringify({ name }) }),
